...
public class DogProduct6 extends JFrame implements MouseListener, ActionListener{
	JPanel panel;
	...
	private String product = "Dog E Collar";
	...
	public DogProduct6(){
		...
		img=new ImageIcon("Images/Big/dogecollar.jpg");
	...
	public void actionPerformed(ActionEvent ae){
		if(ae.getSource() == combo){
			...
			if(index == 0){
				...
				po.setPriceDp6(updatePrice, redirect, this);
