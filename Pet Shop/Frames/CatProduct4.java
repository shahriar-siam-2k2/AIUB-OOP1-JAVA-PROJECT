...
public class CatProduct4 extends JFrame implements MouseListener,ActionListener{
	JPanel panel;
	...
	private String product = "Cat Bag";
	...
	public CatProduct4(){
		...
		img=new ImageIcon("Images/Big/CatBag.jpg");
	...
	public void actionPerformed(ActionEvent ae){
		if(ae.getSource() == combo){
			...
			if(index == 0){
				...
				po.setPriceCp4(updatePrice, redirect, this);
