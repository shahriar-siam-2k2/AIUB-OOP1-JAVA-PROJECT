...
public class CatProduct5 extends JFrame implements MouseListener,ActionListener{
	JPanel panel;
	...
	private String product = "Meow Mix Dry Cat Food";
	private double updatePrice;
	private int redirect = 1; // Cat = 1, Dog = 2

	public CatProduct5(){
		
		super("Meow Mix Dry Cat Food");
		...
		name=new JLabel("Meow Mix Dry Cat Food");
		...
		img=new ImageIcon("Images/Big/MeowMixDryCatFood.jpg");
	...
	public void actionPerformed(ActionEvent ae){
		if(ae.getSource() == combo){
			...
			if(index == 0){
				...
				po.setPriceCp5(updatePrice, redirect, this);
